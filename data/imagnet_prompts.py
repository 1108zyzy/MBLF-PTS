...
ID_to_prompts={
    ...
    'cars': ['a photo of a {}, a type of car.'],
    'ucf101': ['a photo of a person doing {}.'],
    'caltech101': tip_imagenet_templates,
    'food101': ['a photo of {}, a type of food.'],
    'sun397': tip_imagenet_templates,
    'aircraft': ['a photo of a {}, a type of aircraft.'],
    'eurosat': ['a centered satellite photo of {}.']
}

# CuPL prompts（用 GPT 生成的更丰富描述）
ID_to_gptprompts_path={
    'flower102': 'CuPL_prompts_flowers102.json',
    'dtd': 'CuPL_prompts_dtd.json',
    'pets': 'CuPL_prompts_oxfordpets.json',
